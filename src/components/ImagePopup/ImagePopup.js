function ImagePopup(props) {
    return (
      <section className={`popup popup_viewing-place-photo ${props.card.id && 'popup_display_flex'}`}>
        <div className="popup__container-photo">
          <figure className="popup__figure">
            <img className="popup__photo-image" src={props.card.url} alt={props.card.name} />
